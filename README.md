...
2.  Tải về file **`Pixel.Widget.Setup.1.0.0.exe`**.
...
## 🛠️ Công nghệ sử dụng
*   **Electron.js**: Khung ứng dụng desktop đa nền tảng.
*   **Google Tasks API**: Đồng bộ hóa dữ liệu đám mây.
*   **OpenWeatherMap API**: Dữ liệu thời tiết chính xác.
*   **Aesthetics**: 8-bit Pixel Art Layout, VT323 Typography.
